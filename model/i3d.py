...
class Unit3D(nn.Module):
    ...
    def __init__(self, in_channels,
        ...
        if self._use_batch_norm:
            ...
            self.bn = _normalization_3d(self._output_channels, norm)
...
class InceptionI3D(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True, final_endpoint='logits',
                 name='inception_i3d', in_channels=1, dropout_keep_prob=1.0, norm='bn'):
        ...
        end_point = 'AvgPool_5'
        self.layers[end_point] = nn.AvgPool3d(kernel_size=[8, 6, 8], stride=(1, 1, 1))

        end_point = 'Dropout_5'
        self.layers[end_point] = nn.Dropout(self._dropout_rate, inplace=True)
        
        self.classifier = nn.Linear(in_features=384+384+128+128, out_features=self._num_classes)
        ...
        #self.layers[end_point] = nn.Linear(num_features, num_classes)
